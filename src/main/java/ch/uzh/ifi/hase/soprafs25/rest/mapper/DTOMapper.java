...
public interface DTOMapper {
  ...
  @Mapping(target = "id", source = "userId") // Map userId to id for client compatibility
  @Mapping(source = "username", target = "username")
  ...
  @Mapping(target = "actor", expression = "java(String.join(\", \", movieGetDTO.getActors()))")
  ...
  @Mapping(source = "genre", target = "genre")
  @Mapping(source = "year", target = "year")
  @Mapping(target = "actors", expression = "java(movie.getActor() != null ? movie.getActor().split(\", \") : new String[0])")
  @Mapping(source = "director", target = "director")
  @Mapping(source = "originallanguage", target = "originallanguage")
  @Mapping(source = "posterURL", target = "posterURL")
  @Mapping(source = "trailerURL", target = "trailerURL")
